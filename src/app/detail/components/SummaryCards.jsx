...
export default function SummaryCards({ allSubunits, isMobile }) {
  ...
  const statItems = [
    ...
    { icons: <PendingIcon fontSize="large" />, title: 'รอลงเลือก', value: statCard?.total_student ? (statCard?.total_student - statCard?.registered) - statCard.king : 0, unit: 'คน', color: '#FFD32C' },
